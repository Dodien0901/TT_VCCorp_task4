package com.example.vccorp_task4.service;

import com.example.vccorp_task4.dao.UserDao;
import com.example.vccorp_task4.dao.UserDaoImpl;
...
public class UserService {
    ...
    public List<User> findAllSortedByName() throws SQLException {
        return userDao.findAll(); // Already sorted by name in the DAO
    }
}